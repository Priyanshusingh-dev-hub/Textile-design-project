...
export type View = 'Import' | 'Color Analysis' | 'Color Separation' | 'Color Mapping' | 'Layers' | 'Plates' | 'Repeat' | 'Preview' | 'Export';
export const TABS: View[] = ['Import', 'Color Analysis', 'Color Separation', 'Color Mapping', 'Layers', 'Plates', 'Repeat', 'Preview', 'Export'];
