...
export type Layer = { id: string; name: string; color: string; coverage: number; url: string; mask_url?: string; visible?: boolean; opacity?: number; halftonePreviewUrl?: string };
