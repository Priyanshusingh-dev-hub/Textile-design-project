...
import { Upload, Palette as PaletteIcon, Layers, Repeat2, Download, ChevronRight, LayoutGrid, Sparkles } from 'lucide-react';
import { TABS, type View } from '../types';

const ICONS = [Upload, PaletteIcon, Sparkles, Layers, PaletteIcon, Layers, LayoutGrid, Repeat2, PaletteIcon, Download];
